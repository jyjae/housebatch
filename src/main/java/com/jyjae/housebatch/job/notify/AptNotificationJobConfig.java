package com.jyjae.housebatch.job.notify;

import com.jyjae.housebatch.adapter.FakeSendService;
import com.jyjae.housebatch.core.dto.AptDto;
import com.jyjae.housebatch.core.dto.NotificationDto;
import com.jyjae.housebatch.core.entity.AptNotification;
import com.jyjae.housebatch.core.repository.AptNotificationRepository;
import com.jyjae.housebatch.core.repository.LawdRepository;
import com.jyjae.housebatch.core.service.AptDealService;
import com.jyjae.housebatch.job.validator.DealDateParameterValidator;
    ...
    public ItemProcessor<AptNotification, NotificationDto> aptNotificationProcessor(
        ...
        return aptNotification -> {
            ...
            String guName = lawdRepository
                    .findByLawdCd(aptNotification.getGuLawdCd() + "00000")
